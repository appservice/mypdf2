...
app
		.controller(
				...
				[
						...
						'UploadFileFactory',
						'$location',
						function($scope, TableViewsFactory, TableViewFactory,
								UploadFileFactory, quickRepeatList, $location) {
							...
							// -----------------------------------------------------------
							$scope.addWarehouseReleasePerson = function(
									tableView) {
								var currentVersion = tableView.version;
							...
							$scope.uploadFile = function() {
								...
								var orderReferenceInputTxt = document
										.getElementById("orderReferenceInputTxt");

								var buttonSendFile = document
										.getElementById("sendFile");

								buttonSendFile.setAttribute('disabled',
										'disabled');
	...
	//============================grid ==================================================================						
							...
							//var rowtpl='<div ng-class="{\'green\':true, \'blue\':row.entity.isDispatched==true }"><div ng-repeat="(colRenderIndex, col) in colContainer.renderedColumns track by col.colDef.name" class="ui-grid-cell" ng-class="{ \'ui-grid-row-header-cell\': col.isRowHeader }" ui-grid-cell></div></div>';
							...
							$scope.gridOptions.columnDefs = [
									...
									//	cellTemplate : '<input id="editBtn" type="checkbox" checked="false"  />'*/
									    //cellTemplate : "<input name='isDispatched'  type='checkbox' data-bind='checked: isDispatched' #= isDispatched ? checked='checked' : '' #/>"
							...
							$scope.gridOptions.onRegisterApi = function(gridApi) {
								...
								gridApi.edit.on.afterCellEdit($scope, function(
									...
									//	alert("uwaga: kolumna "+colDef.name+" :"+JSON.stringify(rowEntity));
