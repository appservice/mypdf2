...
public class ItemEndpointd {
	...
	public Response create(Item entity) {
		...
		return Response.created(
				UriBuilder.fromResource(ItemEndpointd.class)
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Item> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT i FROM Item i LEFT JOIN FETCH i.order WHERE i.id = :entityId ORDER BY i.id",
						Item.class);
	...
	public List<Item> listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<Item> findAllQuery = em
				.createQuery(
						"SELECT DISTINCT i FROM Item i LEFT JOIN FETCH i.order ORDER BY i.id",
						Item.class);
